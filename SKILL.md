...
20. The helper auto-normalizes AI disclaimer messages that arrive as one inline HTML blob, but you should still prefer an explicit list-based structure so Asana renders line breaks predictably.
