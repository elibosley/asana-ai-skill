...
35. The desired `daily-briefing` output is a reviewed JSON plan where the AI also authors the final human-facing markdown directly in `final_markdown`. Python should validate and pass that markdown through, not own the briefing template.
